...
Nombres de las columnas del data frame "bulls":
Breed (1/5/8), 
Sale Price, 
...
```{r}
#Están malos los linkgs anteriores, pero en los archivos del curso estaba 
#guardado el archivo olive.txt
...
df5
#con rbind se puede añadir una nueva fila al dataframe justo después de la última fila (tambien se puede utilizar cbind para añadir una nueva columna)
df5 = rbind(df5, c("H", 30, 1))
df5
df5$Sexo = as.character(df5$Sexo)
#otra forma de añadir una nueva columna
...
str(df_m)
#eliminar niveles de los factores que no se están usando
...
```{r}
library(tidyverse)
#select para seleccionar columnas que cumplen cierta condición
